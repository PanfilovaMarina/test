...
Инструкция по установке: [Процесс установки](https://github.com/PanfilovaMarina/test/tree/1c8c52762898358f5151d90b4efcb59f7ab915c2/Установка/Процесс-установки/README.md).
...
Нажмите кнопку **Применить** \(иконка ![manage-backup.png](https://github.com/PanfilovaMarina/test/tree/1c8c52762898358f5151d90b4efcb59f7ab915c2/manage-backup.png) в столбце **Управление**\). Система будет перезагружена для применения настроек сервера.
